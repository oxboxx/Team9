...
class BuyerMyCollectionsWidget extends StatefulWidget {
  const BuyerMyCollectionsWidget({Key? key}) : super(key: key);

  @override
  _BuyerMyCollectionsWidgetState createState() =>
      _BuyerMyCollectionsWidgetState();
}

class _BuyerMyCollectionsWidgetState extends State<BuyerMyCollectionsWidget> {
        ...
        child: StreamBuilder<List<NftsRecord>>(
          stream: queryNftsRecord(
            queryBuilder: (nftsRecord) =>
                nftsRecord.where('users', arrayContains: currentUserReference),
          ),
